...
function rotOran() {
	/*vartemp_ang = angles[0]; 
	angles[0] = angles[2];
	angles[2] = angles[3]; 
	angles[3] = angles[1];
	angles[1] = temp_ang;
	for (var y=0;y<4;y++) {
		angles[y][2] = (angles[y][2] + 270)%360;
	}*/
	for (var y=0;y<4;y++) {
...
function cubeRender(face) {
	...
	for( var y = 0;y<NUMBER_SQUARES;y++){
		...
		if (y >= 4) temp[1]+=180;
		/*
		var radianx = ((angles[y][0]+315)%360) * (Math.PI/180.0);
		var radiany = ((angles[y][1]+45)%360) * (Math.PI/180.0);*/
		var radianx = ((temp[0])%360) * (Math.PI/180.0);
		var radiany = ((temp[1])%360) * (Math.PI/180.0);
		var radianz = temp[2] * (Math.PI/180.0);
		
		//if (temp[1] == 
		/*if (temp[2] == 90) {
			radianx = ((temp[0]+135+90)%360)*(Math.PI/180.0);
			radiany = ((temp[1]+135)%360)*(Math.PI/180.0);
			radianz = ((temp[2]+180)%360)*(Math.PI/180.0);
		}
		else if(temp[2] ==180) {
			radianx = ((temp[0]+45)%360)*(Math.PI/180.0);
			radiany = ((temp[1]+315)%360)*(Math.PI/180.0);
			//radianz = ((temp[2]+45)%360)*(Math.PI/180.0);
		}
		if (temp[2] == 270) {
			radianx = ((temp[0]+135)%360)*(Math.PI/180.0);
			radiany = ((temp[1]+135+90)%360)*(Math.PI/180.0);
			radianz = ((temp[2]+180)%360)*(Math.PI/180.0);
		}*/
